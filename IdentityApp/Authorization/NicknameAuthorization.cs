...
{
    public class NicknameAuthorization : AuthorizationHandler<NickNameCheck>
    {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, NickNameCheck requirement)
        {
