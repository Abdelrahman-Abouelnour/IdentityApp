...
namespace IdentityApp.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                var userRole = roles.FirstOrDefault(r => r.UserId == user.Id);
                ...
                else
                {
                    var roleName = _context.Roles
                        .FirstOrDefault(r => r.Id == userRole.RoleId)?.Name;
        ...
        public IActionResult Edit(string userId)
        {
            ...
            var role = userRoles.FirstOrDefault(r => r.UserId == user.Id);
            if (role != null)
            {
                user.RoleId = roles.FirstOrDefault(r => r.Id == role.RoleId)?.Id;
            }
            user.RoleList = roles.Select(r => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem
            {
                Value = r.Id,
                Text = r.Name
            });
